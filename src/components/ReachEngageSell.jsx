...
export default function ReachEngageSell() {
  return (
    <section className="">
      {/* Top Ellipse */}
      <TopEllipse color="#ffffff" height={200} />

      {/* Content Wrapper */}
      <div className="relative z-10 bg-white pb-[100px] lg:pb-[200px]">
        {/* Heading */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center mb-10">
          ...
          <div className="space-y-6 flex flex-col justify-center">
            {[
              ...
              <div
                key={idx}
                className="bg-[#F8FAF2] p-6 rounded-lg shadow hover:shadow-md transition"
              >
                <div className="mb-3">
